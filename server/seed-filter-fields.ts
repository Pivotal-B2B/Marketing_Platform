...
import { db } from './db';
import { filterFieldRegistry } from '@shared/schema';
...
const filterFields: FilterFieldDef[] = [
  ...
  { entity: 'account', key: 'employeesSizeRange', label: 'Employee Count Range', type: 'string', operators: ['equals', 'notEquals', 'isEmpty', 'isNotEmpty'], category: 'account_fields', isCustom: false, sortOrder: 5 },
