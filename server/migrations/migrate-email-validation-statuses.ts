/**
 * Migration: EmailListVerify to API-Free Email Validation Status Mapping
 * 
 * This migration safely remaps legacy EmailListVerify statuses to the new 10-status system.
 * 
 * Legacy Mapping:
 ...
 * 
 * Run this BEFORE deploying the EmailListVerify removal to ensure backwards compatibility.
 */
...
export async function migrateEmailValidationStatuses() {
  ...
  try {
    ...
    // Remap 'ok' → 'safe_to_send' (treating EmailListVerify 'ok' as highest quality)
