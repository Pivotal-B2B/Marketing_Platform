              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 bg-muted rounded-lg">
                    ...
                    <Badge className="mt-2 bg-green-500/10 text-green-500 border-green-500/20">Excellent</Badge>
                  </div>
                  <div className="p-4 bg-muted rounded-lg">
                    <div className="text-sm text-muted-foreground">Tone Match</div>
                    <div className="text-2xl font-bold mt-1 capitalize">{tone}</div>
                    <Badge className="mt-2 bg-blue-500/10 text-blue-500 border-blue-500/20">Matched</Badge>
                  </div>
                  <div className="p-4 bg-muted rounded-lg">
                    <div className="text-sm text-muted-foreground">Estimated Engagement</div>
                    <div className="text-2xl font-bold mt-1">High</div>
                    <Badge className="mt-2 bg-purple-500/10 text-purple-500 border-purple-500/20">Optimized</Badge>
                  </div>
                </div>
              </CardContent>
            </Card>
